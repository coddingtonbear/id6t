"""
Django settings for id6t project.
...
SECRET_KEY = '(xaf23$#t_7^7$h)%)p0&or@eo!otp*-wr4zetb2q9m!c87t5a'
...
WSGI_APPLICATION = 'id6t.wsgi.application'
ASGI_APPLICATION = 'id6t.routing.application'
...
ENVIRONMENT_SETTING_PREFIX = "ID6T_"
